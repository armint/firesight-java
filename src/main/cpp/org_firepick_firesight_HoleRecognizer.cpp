...
JNIEXPORT jlongArray JNICALL Java_org_firepick_firesight_HoleRecognizer_scan (JNIEnv *env, jclass, jlong nativeObject, jlong nativeMat, jfloat maxEllipse, jfloat maxCovar){
